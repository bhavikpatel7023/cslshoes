		...
		for d in self.receivables:
			...
			for k in list(self.party_total[d.party]):
				if k not in ["currency", "sales_person"]:
					...
					self.party_total[d.party]["total"] = self.party_total[d.party]["range1"] + self.party_total[d.party]["range2"] + self.party_total[d.party]["range3"] + self.party_total[d.party]["range4"] + self.party_total[d.party]["range5"]
